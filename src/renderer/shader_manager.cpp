...
bool ShaderManager::load_shader(const std::string& name, const std::string& vertex_path, const std::string& fragment_path) {
...
void ShaderManager::set_uniform_mat4(const std::string& shader_name, const std::string& uniform_name, const glm::mat4& matrix) {
...
void ShaderManager::set_uniform_vec3(const std::string& shader_name, const std::string& uniform_name, const glm::vec3& vector) {
    GLint location = get_uniform_location(shader_name, uniform_name);
    if (location != -1) {
        use_shader(shader_name);
...
void ShaderManager::set_uniform_vec4(const std::string& shader_name, const std::string& uniform_name, const glm::vec4& vector) {
    GLint location = get_uniform_location(shader_name, uniform_name);
    if (location != -1) {
        use_shader(shader_name);
