...
public:
    ...
    VoxelVolume();
    VoxelVolume(double voxel_size, uint32_t num_x, uint32_t num_y, uint32_t num_z);
    ~VoxelVolume();
     ...
     */
    double compute_volume_fraction_inside(
     ...
     */
    double compute_volume_fraction_inside_fast(
        const glm::dvec3& voxel_min,
        const glm::dvec3& voxel_max,
        const Simulator* simulator,
     ...
     */
    double compute_voxel_volume_fraction(
